...
--
-- Servidor: localhost
-- Tiempo de generación: 14-03-2024 a las 14:53:13
...
INSERT INTO `tbl_usuarios` (`idtbl_usuarios`, `nombres`, `apellidos`, `username`, `password`, `tpo_usuario`, `tbl_empleado_idtbl_empleado`) VALUES(1, 'BARREIRO PINARGOTE', 'JEFFERSON ISAAC', '1315681575', '$2y$12$U/0vwkVhlhufOlJH0fhtsO6rWzBnMSG8yhZJ18TD6d6YUkpPu5ox6', 'admin', NULL);
...
--
ALTER TABLE `tbl_usuarios`
  MODIFY `idtbl_usuarios` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
